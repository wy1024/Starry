(function () {
    ...
    angular
        .module('Starry')
        .factory('KolUserService', UserService);
    ...
    function UserService($http, $q, $timeout) {
        ...
        function GetByUsername(username) {
            ...
            return $http.get('http://starrywebapi.azurewebsites.net/' + 'api/DatabaseApi/GetKolUserByUsername/' + username).then(handleSuccess, handleError('Error getting user by username'));
        ...
        function GetNameByUsername(username) {
            ...
            return $http.get('http://starrywebapi.azurewebsites.net/' + 'api/DatabaseApi/GetKolNameByUsername/' + username).then(handleSuccess, handleError('Error getting user by username'));
        }
                    ...
                    GetByUsername(user.username)
                        .then(function (userExists) {
                            if (userExists === 'true') {
                                ...
                                return $http.post('http://starrywebapi.azurewebsites.net/' + 'api/DatabaseApi/AddNewKolUser', user);
